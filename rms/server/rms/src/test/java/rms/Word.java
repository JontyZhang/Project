...
public class Word {
    ...
    public static void main(String[] args)throws Exception {  
        ...
        File file = new File("C:/Users/37742/Desktop/testWord/合同.docx");
       ...
       // FileOutputStream OUT2 = new Fil
        ...
        String name2 = "44538119941008377X";
        infoTableRowOne.addNewTableCell().setText(name1);  
        ...
        run12.setText("甲方将自有的坐落在______市______街道______小区______栋______号的房屋出租给乙方使用。");
        run12.setText("\r");
        ...
        run21.setText("租赁期共______个月，甲方从______年______月______日起将出租房屋交付乙方使用，至______年______月______日收回。");
        run21.setText("\r");
        ...
        run31.setText("本房屋月租金为人民币______元，按月/季度/年结算。每月月初/每季季初/每年年初X日内，乙方向甲方支付全月/季/年租金。");
        run31.setText("\r");
        ...
        run41.setText("乙方应于本合同生效之日起___日内，将该房屋交付给甲方。");
        run41.setText("\r");
        ...
        run61.setText("租赁期共______个月，甲方从______年______月______日起将出租房屋交付乙方使用，至______年______月______日收回。");
        ...
        run71.setText("租赁期满后，如乙方要求继续租赁，则须提前___个月向甲方提出，甲方收到乙方要求后___天内答复。如同意继续租赁，则续签租赁合同。同等条件下，乙方享有优先租赁的权利。");
        ...
        run81.setText("在房屋租赁期间，任何一方提出终止合同，需提前_____月书面通知对方，经双方协商后签订终止合同书，在终止合同书签订前，本合同仍有效。");
        XWPFParagraph firstParagraph82 = document.createParagraph();  
        XWPFRun run82= firstParagraph82.createRun();  
        run82.setText("受不可抗力因素影响，甲方必须终止合同时，一般应提前_____个月书面通知乙方。乙方的经济损失甲方不予补偿。");
